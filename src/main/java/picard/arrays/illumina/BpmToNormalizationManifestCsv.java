...
public class BpmToNormalizationManifestCsv extends CommandLineProgram {
    ...
    protected int doWork() {
        ...
        InfiniumEGTFile infiniumEGTFile = null;
        try {
        ...
        try (BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
            ...
            for (IlluminaBPMLocusEntry locusEntry : bpmFile.getLocusEntries()) {
                ...
                writer.write("" + (locusEntry.index + 1));
                writer.write(",");
                writer.write(locusEntry.name);
                writer.write(",");
                writer.write(locusEntry.chrom);
                writer.write(",");
                writer.write("" + locusEntry.mapInfo);
                writer.write(",");
                writer.write(df.format(genTrainScore));
                writer.write(",");
                writer.write(locusEntry.snp);
                writer.write(",");
                writer.write(locusEntry.ilmnStrand);
                writer.write(",");
                writer.write(locusEntry.customerStrand);
                writer.write(",");
                writer.write("" + locusEntry.normalizationId);
                writer.newLine();
            }
        } catch (IOException e) {
